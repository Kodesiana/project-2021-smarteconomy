...
CREATE UNIQUE NONCLUSTERED INDEX ix_users_username ON users ( username ASC );
...
CREATE UNIQUE NONCLUSTERED INDEX ix_villages_name ON villages ( name ASC );
...
CREATE TABLE village_investment (
	id nvarchar(30) NOT NULL,
	village_id nvarchar(30) NOT NULL,
...
CREATE UNIQUE NONCLUSTERED INDEX ix_village_investment_village_id ON village_investment ( village_id ASC );
...
CREATE TABLE questionnaire_answer (
	...
	work_class nvarchar(50) NOT NULL,
...
CREATE NONCLUSTERED INDEX ix_questionnaire_answer_village_id ON questionnaire_answer ( village_id ASC );
...
CREATE TABLE synthesis_citizen_science (
	id nvarchar(30) NOT NULL,
	village_id nvarchar(30) NULL,
	sempls_order tinyint NOT NULL,
	status tinyint NOT NULL,
	json_result nvarchar(MAX) DEFAULT N'' NOT NULL,
...
CREATE NONCLUSTERED INDEX ix_synthesis_citizen_science_village_id ON synthesis_citizen_science ( village_id ASC );
...
CREATE TABLE synthesis_cooperation (
	...
	json_alternatives nvarchar(MAX) DEFAULT N'' NOT NULL,
	json_factors nvarchar(MAX) DEFAULT N'' NOT NULL,
...
CREATE NONCLUSTERED INDEX ix_synthesis_cooperation_village_id ON synthesis_cooperation ( village_id ASC );
...
CREATE TABLE synthesis_infrastructure (
	...
	potential nvarchar(255) NOT NULL,
...
CREATE NONCLUSTERED INDEX ix_synthesis_infrastructure_village_id ON synthesis_infrastructure ( village_id ASC );
