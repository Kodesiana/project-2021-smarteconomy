...
import SplitLayout from "../../../layout/split/SplitLayout";
import HeaderModule from "../../main/header/HeaderModule";
...
function SettingsModule() {
    ...
    return (
        <>
            ...
            <Tabs variant="pills" orientation="vertical" defaultValue="general" style={{ height: "100%", minHeight:"calc(100vh - 64px)" }}>
                <Tabs.List className={clsx(classes.sidebar, styles.header)}>
                    <Title my={16} order={4}>Pengaturan</Title>
                    <Tabs.Tab value="general" icon={<BoundingBox size={14} />}>Umum</Tabs.Tab>
                    <Tabs.Tab value="profile" icon={<UserGear size={14} />}>Profil</Tabs.Tab>
                    <Tabs.Tab value="notifications" icon={<Notification size={14} />}>Notifikasi</Tabs.Tab>
                </Tabs.List>
                <Tabs.Panel value="general" className={classes.content}>
                    <SwitchesCard className={classes.switchGroup} title={"Tampilan"} description={""} data={[
                        {
                            title: "Bahasa",
                ...
                <Tabs.Panel value="profile" className={classes.content}>
                    <SwitchesCard className={classes.switchGroup} title={"Profil"} description={""} data={[
                        {
                            title: "Nama",
                    ...
                    <SwitchesCard className={classes.switchGroup} title={"Keamanan"} description={""} data={[
                        {
