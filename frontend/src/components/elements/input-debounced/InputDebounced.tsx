...
const InputDebounced: FC<InputDebouncedProps> = ({ className, value: initialValue, onChange, debounce = 500, ...props }: InputDebouncedProps & Omit<React.InputHTMLAttributes<HTMLInputElement>, "onChange">) => {
